...
const UserManual = () => {
const downloadPdf = () => {
	const path='/UserManual'

    const link = document.createElement('a');
    link.href = path;
    link.download = 'DSA-Sorting_User-Manuals.pdf';
    link.click();
  };
...
const goBack = () => {
  ...
  return (
    <div className="body">
      ...
      <div class='tooltip'>
      <div class='btn'>
          <button onClick={downloadPdf}>Download User Manual</button>
      </div>
      <span class='tooltiptext'>Click to download the user manual</span>
      </div>
